...
// Definisikan tipe data untuk struktur data yang digunakan
type RoomOption = {
  id: string;
  title: string;
  subtitle: string;
...
type Review = {
  ...
  rating: number;
  text: string;
  profilePic: string; // pastikan ini string, bukan number
};
...
const DetailApartmentScreen: React.FC = () => {
  return (
    <ScrollView style={styles.container}>
      {/* Bagian Header dan Gambar Utama */}
      ...
      <View style={styles.section}>
        ...
        <View style={styles.facilitiesRow}>
          ...
          <View style={styles.facilityItem}>
            <AntDesign name="tago" size={24} color="#999" />
            <Text style={styles.facilityText}>Dapur</Text>
          </View>
        </View>
      ...
      <View style={styles.section}>
        ...
        <MapView
          style={styles.map}
          initialRegion={{
            latitude: -6.9915, // latitude Semarang
            longitude: 110.4225, // longitude Semarang
            latitudeDelta: 0.01,
            longitudeDelta: 0.01,
          }}
        >
        ...
        {roomOptions.map((room) => (
          <View key={room.id} style={styles.roomItem}>
            ...
            <View style={styles.roomDetails}>
              ...
              <View style={styles.roomTags}>{/* Tags */}</View>
            </View>
